...
public class SnackSaladClassicItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:snack_salad_classic")
	public static final Item block = null;

	public SnackSaladClassicItem(BetterMcdonaldsModModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(BetterMcDonaldsCreativeTabItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(10f)

							.build()));
			setRegistryName("snack_salad_classic");
		}
