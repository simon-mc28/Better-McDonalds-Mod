...
public class ChickenMcNuggetsItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:chicken_mc_nuggets")
	public static final Item block = null;

	public ChickenMcNuggetsItem(BetterMcdonaldsModModElements instance) {
		super(instance, 29);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(BetterMcDonaldsCreativeTabItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(8).saturation(10f)
							...
							.build()));
			setRegistryName("chicken_mc_nuggets");
		}
