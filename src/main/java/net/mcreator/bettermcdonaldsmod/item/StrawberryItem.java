...
public class StrawberryItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:strawberry")
	public static final Item block = null;

	public StrawberryItem(BetterMcdonaldsModModElements instance) {
		super(instance, 14);
	}
