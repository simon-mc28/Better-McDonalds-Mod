...
public class TomatoItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:tomato")
	public static final Item block = null;

	public TomatoItem(BetterMcdonaldsModModElements instance) {
		super(instance, 15);
	}
