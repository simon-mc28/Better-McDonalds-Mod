...
public class McSundaeChocolateItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:mc_sundae_chocolate")
	public static final Item block = null;

	public McSundaeChocolateItem(BetterMcdonaldsModModElements instance) {
		super(instance, 36);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(BetterMcDonaldsCreativeTabItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(6).saturation(10f)
							...
							.build()));
			setRegistryName("mc_sundae_chocolate");
		}
