...
public class ChocolateMilkshakeItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:chocolate_milkshake")
	public static final Item block = null;

	public ChocolateMilkshakeItem(BetterMcdonaldsModModElements instance) {
		super(instance, 34);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(BetterMcDonaldsCreativeTabItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(6).saturation(10f)
							...
							.build()));
			setRegistryName("chocolate_milkshake");
		}
