...
public class CocaoPowderItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:cocao_powder")
	public static final Item block = null;

	public CocaoPowderItem(BetterMcdonaldsModModElements instance) {
		super(instance, 8);
	}
