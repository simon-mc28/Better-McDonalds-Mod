...
public class CheeseItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:cheese")
	public static final Item block = null;

	public CheeseItem(BetterMcdonaldsModModElements instance) {
		super(instance, 7);
	}
