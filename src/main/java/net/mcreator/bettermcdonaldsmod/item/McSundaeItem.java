...
public class McSundaeItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:mc_sundae")
	public static final Item block = null;

	public McSundaeItem(BetterMcdonaldsModModElements instance) {
		super(instance, 35);
	}
