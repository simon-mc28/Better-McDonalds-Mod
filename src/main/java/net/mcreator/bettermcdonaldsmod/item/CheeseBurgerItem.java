...
public class CheeseBurgerItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:cheese_burger")
	public static final Item block = null;

	public CheeseBurgerItem(BetterMcdonaldsModModElements instance) {
		super(instance, 23);
	}
