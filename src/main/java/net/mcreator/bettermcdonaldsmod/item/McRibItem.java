...
public class McRibItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:mc_rib")
	public static final Item block = null;

	public McRibItem(BetterMcdonaldsModModElements instance) {
		super(instance, 27);
	}
