...
public class SaltItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:salt")
	public static final Item block = null;

	public SaltItem(BetterMcdonaldsModModElements instance) {
		super(instance, 11);
	}
