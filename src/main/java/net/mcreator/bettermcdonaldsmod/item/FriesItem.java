...
public class FriesItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:fries")
	public static final Item block = null;

	public FriesItem(BetterMcdonaldsModModElements instance) {
		super(instance, 28);
	}
