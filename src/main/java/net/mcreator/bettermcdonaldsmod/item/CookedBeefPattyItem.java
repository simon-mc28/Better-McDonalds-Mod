...
public class CookedBeefPattyItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:cooked_beef_patty")
	public static final Item block = null;

	public CookedBeefPattyItem(BetterMcdonaldsModModElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(BetterMcDonaldsCreativeTabItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(6.4f)

							.meat().build()));
			setRegistryName("cooked_beef_patty");
		}
