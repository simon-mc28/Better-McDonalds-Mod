...
public class RawBeefPattyItem extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:raw_beef_patty")
	public static final Item block = null;

	public RawBeefPattyItem(BetterMcdonaldsModModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("raw_beef_patty");
		}
