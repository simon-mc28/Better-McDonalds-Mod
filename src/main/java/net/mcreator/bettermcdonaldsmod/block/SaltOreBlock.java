...
package net.mcreator.bettermcdonaldsmod.block;
...
import net.mcreator.bettermcdonaldsmod.item.SaltItem;
...
public class SaltOreBlock extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:salt_ore")
	public static final Block block = null;

	public SaltOreBlock(BetterMcdonaldsModModElements instance) {
		super(instance, 16);
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(BetterMcDonaldsCreativeTabItemGroup.tab))
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SaltItem.block, (int) (3)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("better_mcdonalds_mod:salt_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("salt_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("better_mcdonalds_mod:salt_ore"), configuredFeature);
		}
	}
