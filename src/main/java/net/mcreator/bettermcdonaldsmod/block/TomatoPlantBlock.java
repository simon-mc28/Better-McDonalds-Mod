...
import net.mcreator.bettermcdonaldsmod.item.TomatoItem;
...
public class TomatoPlantBlock extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:tomato_plant")
	public static final Block block = null;

	public TomatoPlantBlock(BetterMcdonaldsModModElements instance) {
		super(instance, 20);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tomato_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("better_mcdonalds_mod:tomato_plant"), configuredFeature);
		}
	}
