...
import net.mcreator.bettermcdonaldsmod.item.StrawberryItem;
...
public class StrawberryPlantBlock extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:strawberry_plant")
	public static final Block block = null;

	public StrawberryPlantBlock(BetterMcdonaldsModModElements instance) {
		super(instance, 19);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("strawberry_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("better_mcdonalds_mod:strawberry_plant"),
					configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(StrawberryItem.block, (int) (2)));
		}
