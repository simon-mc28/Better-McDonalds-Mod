...
import net.mcreator.bettermcdonaldsmod.item.LettuceItem;
...
public class LettucePlantBlock extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:lettuce_plant")
	public static final Block block = null;

	public LettucePlantBlock(BetterMcdonaldsModModElements instance) {
		super(instance, 17);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lettuce_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("better_mcdonalds_mod:lettuce_plant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LettuceItem.block, (int) (2)));
		}
