...
import net.mcreator.bettermcdonaldsmod.item.SpiceLeafItem;
...
public class SpiceLeafPlantBlock extends BetterMcdonaldsModModElements.ModElement {
	@ObjectHolder("better_mcdonalds_mod:spice_leaf_plant")
	public static final Block block = null;

	public SpiceLeafPlantBlock(BetterMcdonaldsModModElements instance) {
		super(instance, 18);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("spice_leaf_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("better_mcdonalds_mod:spice_leaf_plant"),
					configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("spice_leaf_plant");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SpiceLeafItem.block, (int) (2)));
		}
